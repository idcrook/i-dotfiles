...
dest_media="/Volumes/Pictures/Backup"
rsync=/usr/bin/rsync
cp=/bin/cp
...
# try to make sure that "Pictures" Volume is mounted
...
RSYNC_OPTS="-rtv -4 --modify-window=1 --delete --delete-excluded --itemize-changes --human-readable --progress --stats  --exclude-from=/Users/dpc/bin/macos/backups/itunes_rsync_exclude"
